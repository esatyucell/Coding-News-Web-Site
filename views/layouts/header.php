...
@media (max-width: 768px) {
  ...
  .mainNav__links {
    ...
    background: #ffffffff; /* dark theme */
    position: absolute;
    top: 100%;
    left: 0;
    width: 100%;
  ...
  .mainNav__links.active {
    max-height: 500px; /* Menü boyuna göre ayarla */
    opacity: 1;
    border-top: 1px solid #8c8c8c55; /* çizgi */
  }
...
<body>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      const burger = document.querySelector(".mainNav__icon");
